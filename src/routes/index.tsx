    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
          ...
          <nav className="hidden items-center gap-7 text-sm font-medium text-foreground/80 md:flex">
            ...
            <a href="#track" className="hover:text-brand-orange">
              Track
            </a>
      ...
      <section className="relative overflow-hidden">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          ...
          <div
            className="absolute top-[78%] left-0 w-full animate-sail-left"
          ...
          <div
            className="absolute top-[34%] left-0 w-full animate-fly"
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-20 md:grid-cols-2 md:py-28">
          <div className="text-white">
            ...
            <p className="mt-5 max-w-xl text-lg text-white/85">
              Sea groupage, full containers, air freight, and intercity delivery — all tracked from
              origin warehouse to your customer's door. Built for e-commerce, importers, and
              traders.
            </p>
      ...
      <section id="services" className="mx-auto max-w-7xl px-4 py-20">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          {[
            {
              icon: Ship,
              title: "Sea Groupage (LCL)",
              desc: "Priced per CBM. Weekly consolidations from China, UK, and Dubai.",
            },
            {
              icon: Container,
              title: "Full Container (FCL)",
              desc: "20ft and 40ft containers direct to Tema/Takoradi port.",
            },
            {
              icon: Plane,
              title: "Air Freight",
              desc: "Fast air cargo priced per kg for urgent shipments and small parcels.",
            },
            {
              icon: Truck,
              title: "Intercity Ghana",
              desc: "Last-mile delivery to any city in Ghana with signature POD.",
            },
          ].map((s) => (
            <div
              key={s.title}
            ...
            {[
              {
                n: "01",
                t: "Sign up",
                d: "Get your unique NDL-GH shipping mark and our warehouse addresses.",
              },
              {
                n: "02",
                t: "Ship to us",
                d: "Send your parcels to our China, UK, or Dubai warehouse.",
              },
              {
                n: "03",
                t: "We consolidate",
                d: "We weigh, measure, photograph, and load your goods.",
              },
              {
                n: "04",
                t: "Delivered",
                d: "Track live, pay online, and receive at your doorstep.",
              },
            ].map((s) => (
              <div key={s.n} className="rounded-2xl border bg-card p-6">
                <div className="font-display text-4xl font-extrabold text-brand-orange/80">
                  {s.n}
                </div>
          ...
          {[
            {
              icon: ShieldCheck,
              t: "Insured & tracked",
              d: "Every package photographed and logged.",
            },
